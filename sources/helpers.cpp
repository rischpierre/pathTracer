...
void printVec3(const Eigen::Vector3f &v) { std::cout << v[0] << " " << v[1] << " " << v[2] << std::endl; }
...
Eigen::Vector3f toEigen(const pxr::GfVec3f &input) { return Eigen::Vector3f(input[0], input[1], input[2]); }
